...
t('V18.8.38 server version',()=>server.includes("version:'18.8.38'"));
t('V18.8.38 service worker version',()=>sw.includes('ispeak-v18-8-38-play-ready')&&sw.includes("version:'18.8.38'"));
...
console.log(`\n${pass}/${pass+fail} V18.8.38 launch checks passed`);if(fail)process.exit(1);
