...
t('New app cache busting is active',html.includes('app.js?v=18.8.37')&&html.includes('styles.css?v=18.8.37'));
console.log(`\nV18.8.37 interaction QA: ${p}/${p+f} passed`);process.exit(f?1:0);
