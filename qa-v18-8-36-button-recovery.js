...
ok('index loads V18.8.45 app.js',html.includes('app.js?v=18.8.45'));
ok('service worker precaches V18.8.45 app.js',sw.includes("'/app.js?v=18.8.45'"));
ok('service worker uses V18.8.45 cache',sw.includes('ispeak-v18-8-45-hero-entry-hardening'));
...
ok('service worker registration is V18.8.45',app.includes("register('/sw.js?v=18.8.45'"));
console.log(`\\nV18.8.45 button recovery QA: ${pass}/${pass+fail} passed`); if(fail)process.exit(1);
