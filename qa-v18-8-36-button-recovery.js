...
ok('index loads V18.8.38 app.js',html.includes('app.js?v=18.8.38'));
ok('service worker precaches V18.8.38 app.js',sw.includes("'/app.js?v=18.8.38'"));
ok('service worker uses V18.8.38 cache',sw.includes('ispeak-v18-8-38-play-ready'));
...
ok('service worker registration is V18.8.38',app.includes("register('/sw.js?v=18.8.38'"));
console.log(`\\nV18.8.38 button recovery QA: ${pass}/${pass+fail} passed`); if(fail)process.exit(1);
