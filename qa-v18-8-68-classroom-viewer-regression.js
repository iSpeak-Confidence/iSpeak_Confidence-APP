...
t('V18.8.68 package',pkg.version==='18.8.68');
t('V18.8.68 asset cache bust',html.includes('app.js?v=18.8.68')&&html.includes('styles.css?v=18.8.68'));
t('V18.8.68 server status',server.includes("version:'18.8.68'"));
t('Android V18.8.68',/versionCode 21/.test(gradle)&&/versionName '18\.8\.68'/.test(gradle));
