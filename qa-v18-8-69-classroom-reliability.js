...
const checks=[
 ...
 ['student renegotiation fallback',/renegotiate-request/.test(app)&&/sendSignal\('teacher'/.test(app)],
 ...
 ['android version bumped',/versionCode 22/.test(gradle)&&/versionName '18\.8\.69'/.test(gradle)]
];
