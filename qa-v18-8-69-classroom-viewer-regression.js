...
t('V18.8.69 package',pkg.version==='18.8.69');
t('V18.8.69 asset cache bust',html.includes('app.js?v=18.8.69')&&html.includes('styles.css?v=18.8.69'));
t('V18.8.69 server status',server.includes("version:'18.8.69'"));
t('Android V18.8.69',/versionCode 22/.test(gradle)&&/versionName '18\.8\.69'/.test(gradle));
