...
const checks=[
 ...
 ['version package',pkg.version==='18.8.70'],
 ['version assets',html.includes('app.js?v=18.8.70')&&html.includes('styles.css?v=18.8.70')],
 ['version server',server.includes("version:'18.8.70'")],
 ['version android',gradle.includes('versionCode 23')&&gradle.includes("versionName '18.8.70'")&&main.includes('iSpeakAndroid/18.8.70')],
 ['version service worker',sw.includes('ispeak-v18-8-70')&&sw.includes("version:'18.8.70'")]
];
let fail=0;
