...
ok('V17.4.1 cache',sw.includes('ispeak-v17-4-1-core'));
ok('V17.4.1 title',html.includes('iSpeak Confidence V17.4.1'));
ok('Server reports V17.4.1',server.includes("version:'V17.4.1'"));
ok('Placement records V17.4.1',app.includes("version:'17.4.1'};save();"));
